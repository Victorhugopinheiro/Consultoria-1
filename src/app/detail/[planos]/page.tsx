            ...
            <Container>
                ...
                <div className="bg-white w-full flex flex-col md:flex-row rounded-[10px_10px_0px_0px] ">
                    ...
                    <div className={
                        ...
                        <div className=" flex flex-col w-full  sticky gap-3 justify-between rounded-[0px_0px_10px_0px]  bg-slate-900 text-white   p-3 h-[400px] md:h-[450px] lg:h-full">
                            <div className="w-full">
                                ...
                                <div className=" flex flex-col items-center">
                                    <div className="flex flex-col items-center w-full gap-1">
                                        <div>
                                            <span className="text-sm px-6 text-gray-300 opacity-80 line-through">R${contextPlano.oldValue}</span>
                                        ...
                                        <span className="text-sm text-slate-200">Em 12x de R$11,99</span>

                                    </div>


                                    <div className="mt-6  w-3/5 md:w-4/5 flex flex-col p-1 bg-slate-900 rounded-md">
                                        <FormComponent />
                                    </div>
                                </div>
